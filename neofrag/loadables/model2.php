...
abstract class Model2 extends NeoFrag implements \NF\NeoFrag\Loadable
{
	...
	public function check($var, $value, $callback = 'url_title')
	{
		if ($this() && $callback($this->$var) == $value)
		{
			return $this;
		}
	}
	...
	{
		return $this->_data ? parent::form2($this->__name, $this) : parent::form2($this->__name);
	}
