...
class Index extends Controller_Module
{
	...
	public function _forum($forum_id, $title, $category_id, $subforums, $announces, $topics)
	{
		...
		$content = '<a class="btn btn-default pull-left" href="'.url(($this->session->get_back() ?: 'forum')).'">'.$this->lang('Retour').'</a>';
	...
	public function _topic($topic_id, $title, $forum_id, $forum_title, $category_id, $views, $nb_users, $nb_messages, $is_announce, $is_locked, $topic, $messages)
	{
		...
		$content = '<a class="btn btn-default pull-left" href="'.url($this->session->get_back() ?: 'forum/'.$forum_id.'/'.url_title($forum_title)).'">'.$this->lang('Retour').'</a>';
