	...
	<table class="table table-hover"<?php if ($this->url->admin) echo ' data-category-id="'.$data['category_id'].'"' ?>>
		<thead class="forum-heading">
			<tr>
				...
				<th class="col-md-2"><h4 class="no-margin"><?php echo icon('fa-signal') ?><span class="hidden-xs"> <?php echo $this->lang('Statistiques') ?></span></h4></th>
				<th class="col-md-3"><h4 class="no-margin"><?php echo icon('fa-comment-o') ?><span class="hidden-xs"> <?php echo $this->lang('Dernier message') ?></span></h4></th>
