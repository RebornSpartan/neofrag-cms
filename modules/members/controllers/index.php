...
class Index extends Controller_Module
{
	...
	{
		return $this->array
					->append($this->panel()->body('<h2 class="no-margin">'.$this->lang('Groupe').' <small>'.$title.'</small>'.$this->button()->tooltip($this->lang('Voir tous les membres'))->icon('fa-close')->url('members')->color('danger pull-right')->compact()->outline().'</h2>'))
