		...
		<div id="gallery-vignettes" class="row">
			<?php foreach ($data['images'] as $image): ?>
				<div class="gallery-item">
					<div class="thumbnail">
					<a class="thumbnail-link" data-toggle="tooltip" title="<?php echo $this->lang('Visualiser') ?>" data-image="<?php echo path($image['file_id']) ?>" data-title="<?php echo $image['title'] ?>" data-description="<?php echo $image['description'] ?>"><img class="img-responsive" src="<?php echo path($image['thumbnail_file_id']) ?>" alt="" /></a>
						<div class="actions">
