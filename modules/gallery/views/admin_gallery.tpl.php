		...
		<div id="gallery-vignettes" class="row">
			<?php foreach ($images as $image): ?>
				<div class="gallery-item">
					<div class="thumbnail">
<<<<<<< HEAD
					<a class="thumbnail-link" data-toggle="tooltip" title="<?php echo $this->lang('Visualiser') ?>" data-image="<?php echo NeoFrag()->model2('file', $image['file_id'])->path() ?>" data-title="<?php echo $image['title'] ?>" data-description="<?php echo $image['description'] ?>"><img class="img-responsive" src="<?php echo NeoFrag()->model2('file', $image['thumbnail_file_id'])->path() ?>" alt="" /></a>
=======
...
<?php else: ?>
	<div class="alert alert-info text-center no-margin"><?php echo $this->lang('Il n\'y a pas encore d\'image') ?></div>
<?php endif ?>
