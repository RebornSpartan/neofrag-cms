<a href="<?php echo $link = url('events/'.$event_id.'/'.url_title($title)) ?>"><img src="<?php echo path($image_id) ?>" class="img-fluid" alt="" /></a>
...
<div class="panel-body text-center">
	<div class="row vcenter">
		...
		<div class="text-right col-xs-1 vcenter">
			<img src="<?php echo path($match['opponent']['image_id']) ?>" class="img-fluid" alt="" />
		</div>
		<?php endif ?>
		...
		<div class="well well-sm<?php echo (($i+1) == count($rounds)) ? ' no-margin' : '' ?>">
			<div class="row vcenter">
				...
				<div class="col-xs-2 vcenter">
					<img src="<?php echo path($rounds[$i]['image_id']) ?>" class="img-fluid" alt="" />
				</div>
				<?php endif ?>
