		...
		<div id="navigation-options" class="tab-pane active" role="tabpanel">
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select class="form-control" name="settings[align]" id="settings-align">
							<option value="text-left"<?php if (isset($data['align']) && $data['align'] == 'text-left') echo ' selected="selected"' ?>><?php echo $this->lang('Gauche') ?></option>
							<option value="text-center"<?php if (!isset($data['align']) || $data['align'] == 'text-center') echo ' selected="selected"' ?>><?php echo $this->lang('Centré') ?></option>
							<option value="text-right"<?php if (isset($data['align']) && $data['align'] == 'text-right') echo ' selected="selected"' ?>><?php echo $this->lang('Droite') ?></option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" name="settings[title]" value="<?php if (isset($data['title'])) echo $data['title'] ?>" id="settings-title" placeholder="<?php echo $this->lang('Titre par défaut') ?>" />
					</div>
					<div class="col-sm-3">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" name="settings[description]" value="<?php if (isset($data['title'])) echo $data['description'] ?>" id="settings-description" placeholder="<?php echo $this->lang('Description par défaut') ?>" />
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<div class="input-group-addon"><?php echo icon('fa-paint-brush') ?></div>
